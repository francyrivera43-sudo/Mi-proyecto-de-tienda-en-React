...
export default function Login() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          <div className="bg-violet-600 py-10 px-8 text-center">
            ...
            <p className="text-violet-100 mt-2 text-sm">Accede a tu cuenta de STORE.</p>
          </div>
          ...
          <form className="p-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="w-full py-4 shadow-lg shadow-blue-500/30 text-base font-bold">
              Iniciar Sesión
            </Button>
